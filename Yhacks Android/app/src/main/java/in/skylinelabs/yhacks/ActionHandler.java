...
public class ActionHandler {
    ...
    private String address = "192.168.43.108:80";
    ...
    private String REQUEST_MONEY = "http://" + address +"/request_money.php";
    private String PAY_WALLET = "http://" + address +"/pay_wallet.php";
    private String BILL = "http://" + address +"/bill.php";
    private String GET_ALL_LOAN_REQUESTS = "http://" + address +"/loans.php";
    private String GIVE_LOAN = "http://" + address +"/giveloan.php";
    ...
    public void requestMoney(String name, String amount){
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("username", name);
        jsonObject.addProperty("amount", amount);
        postJsonObject(jsonObject, REQUEST_MONEY, "Request", "Fetching");

    }

    public void getAllLoans(String name){
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("username", name);
        postJsonObject(jsonObject, GET_ALL_LOAN_REQUESTS, "Loan", "Fetching");
    }
    ...
    public void giveLoan(String lender,String borrower, int amount){
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("lender", lender);
        jsonObject.addProperty("borrower", borrower);
        jsonObject.addProperty("amount", amount);
        postJsonObject(jsonObject, GIVE_LOAN, "Lend", "Refreshing");
    }
